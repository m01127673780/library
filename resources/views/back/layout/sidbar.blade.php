      ...
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item admin has-treeview {{active_menu('products')[0]}}">
               <a href="#" class="nav-link">
                  <i class="fa fa-scroll nav-icon"></i><p>{{trans('admin.products')}}<i class="fas fa-angle-left right"></i></p>
               </a>
                  ...
                  <li class="nav-item">
                     <button   class="nav-link btn btn-success btn-create-new-row     ">
                        <a href="{{aurl('products/create')}}"  class="">
                           <i class="fas fa-plus "></i><i class="fa fa-scroll"></i> <p class="">{{trans('admin.create_new_products')}}</p>
                        </a>
                     </button>
                  </li>
                  <div class="d-none">
...
{{--                  </div>--}}
            ...
            <li class="nav-item admin has-treeview {{active_menu('ads')[0]}}">
               <a href="#" class="nav-link">
                  <i class="fa fa-flag-checkered nav-icon"></i><p>{{trans('admin.ads')}}<i class="fas fa-angle-left right"></i></p>
               </a>
               <ul class="nav nav-treeview content_W_20px_h_20px" style="{{active_menu('ads')[1]}}">

                  <li class="nav-item"> <a href="{{aurl('ads')}}" class="nav-link">
                        <i class="fa fa-flag-checkered nav-icon"></i><p> <i class="fa fa-file-signature"></i> {{trans('admin.ads')}}</p>
                     </a></li>
                  <li class="nav-item">
                     <button   class="nav-link btn btn-info btn-create-new-row  btn_crete_new_row_ads">
            ...
            <li class="nav-item admin has-treeview {{active_menu('news')[0]}}">
               <a href="#" class="nav-link">
                  <i class="fa fa-flag-checkered nav-icon"></i><p>{{trans('admin.news')}}<i class="fas fa-angle-left right"></i></p>
               </a>
               <ul class="nav nav-treeview content_W_20px_h_20px" style="{{active_menu('news')[1]}}">
                  ...
                  <li class="nav-item"> <a href="{{aurl('news')}}" class="nav-link">
                        <i class="fa fa-flag-checkered nav-icon"></i><p> <i class="fa fa-file-signature"></i> {{trans('admin.news')}}</p>
                     </a></li>
                  <li class="nav-item">
                     <button   class="nav-link btn btn-info btn-create-new-row  btn_crete_new_row_news">
            ...
            <li class="nav-item admin has-treeview {{active_menu('about')[0]}}">
               <a href="#" class="nav-link">
                  <i class="fa fa-flag-checkered nav-icon"></i><p>{{trans('admin.about')}}<i class="fas fa-angle-left right"></i></p>
               </a>
               <ul class="nav nav-treeview content_W_20px_h_20px" style="{{active_menu('about')[1]}}">
                  ...
                  <li class="nav-item"> <a href="{{aurl('about')}}" class="nav-link">
                        <i class="fa fa-flag-checkered nav-icon"></i><p> <i class="fa fa-file-signature"></i> {{trans('admin.about')}}</p>
                     </a></li>
                  <li class="nav-item">
                     <button   class="nav-link btn btn-info btn-create-new-row  btn_crete_new_row_about">
            ...
            <li class="nav-item admin has-treeview {{active_menu('testimonial')[0]}}">
               <a href="#" class="nav-link">
                  <i class="fa fa-flag-checkered nav-icon"></i><p>{{trans('admin.testimonial')}}<i class="fas fa-angle-left right"></i></p>
               </a>
               <ul class="nav nav-treeview content_W_20px_h_20px" style="{{active_menu('testimonial')[1]}}">
                  ...
                  <li class="nav-item"> <a href="{{aurl('testimonial')}}" class="nav-link">
                        <i class="fa fa-flag-checkered nav-icon"></i><p> <i class="fa fa-file-signature"></i> {{trans('admin.testimonial')}}</p>
                     </a></li>
                  <li class="nav-item">
                     <button   class="nav-link btn btn-info btn-create-new-row  btn_crete_new_row_testimonial">
            ...
            <li class="nav-item admin has-treeview {{active_menu('newsletter')[0]}}">
               <a href="#" class="nav-link">
                  <i class="fa fa-flag-checkered nav-icon"></i><p>{{trans('admin.newsletter')}}<i class="fas fa-angle-left right"></i></p>
               </a>
               <ul class="nav nav-treeview content_W_20px_h_20px" style="{{active_menu('newsletter')[1]}}">
                  ...
                  <li class="nav-item"> <a href="{{aurl('newsletter')}}" class="nav-link">
                        <i class="fa fa-flag-checkered nav-icon"></i><p> <i class="fa fa-file-signature"></i> {{trans('admin.newsletter')}}</p>
                     </a></li>
                  <li class="nav-item">
                     <button   class="nav-link btn btn-info btn-create-new-row  btn_crete_new_row_newsletter">
