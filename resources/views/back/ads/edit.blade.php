                                    ...
                                    <!--        {{ Form::button('<i class="fa fa-location-arrow "> '
                                        ...
                                        <div class="col-md-6 content_form_ar" >
                                            <div class="form-group ">
                                                ...
                                                {!! Form::text('title_ar',$ads->title_ar,['class'=>'form-control']) !!}
                                            </div><!-- /.form-group title_ar -->
                                            <div class="form-group ">
                                                {!! Form::label('content_ar',trans('admin.content_ar')) !!}
                                                {!! Form::textarea('content_ar',$ads->content_ar,['class'=>'form-control']) !!}
                                            </div><!-- /.form-group content_en -->
                                            <div class="form-group ">
                                                {!! Form::label('start_at',trans('admin.start_at')) !!}
                                                {!! Form::text('start_at',$ads->start_at,['class'=>'form-control']) !!}
                                        ...
                                        <div class="col-md-6 content_form_en" >
                                            ...
                                            <div class="form-group ">
                                                ...
                                                {!! Form::text('title_en',$ads->title_en,['class'=>'form-control']) !!}
                                            </div><!-- /.form-group title_en -->

                                            <div class="form-group ">
                                                {!! Form::label('content_en',trans('admin.content_en')) !!}
                                                {!! Form::textarea('content_en',$ads->content_en,['class'=>'form-control']) !!}
                                            </div><!-- /.form-group content_en -->

                                            <div class="form-group ">
                                                {!! Form::label('end_at',trans('admin.end_at')) !!}
                                                {!! Form::text('end_at',$ads->end_at,['class'=>'form-control']) !!}
