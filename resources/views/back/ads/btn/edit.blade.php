{{--<a href="{{ aurl('ads/'.$id.'/edit') }}" class="btn btn-info"><i class="fa fa-edit"></i></a>--}}


 <!-- Trigger the modal with a button -->
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#edit_ads{{ $id }}"><i class="fa fa-edit"></i></button>
<!-- Modal -->
<div id="edit_ads{{ $id }}" class="modal fade" role="dialog">
  ...
  <!-- /.----------------------------------------------------------------- -->
                             <div class="box-body">
                                     {!! Form::open(['route'=>['ads.update',$id],'method'=>'put','class'=>'form_save_in_modal','files'=>true]) !!}
                                    <div class="row">
                                   <div class="col-md-12 content_form_ar" >
                                    ...
                                    <div class="input-group ">
                                     ...
                                     @if(!empty($photo))
                                       ...
                                       @else
                                      <div class="text-center"> <img   src="{{url('default')}}/ads.png" class="img_100px"></div>
                                       @endif
                                   <!----------------End photo-->
                                   </section> 
                               </div><!-- col-md-12-->
                             ...
                             <!--        {{ Form::button('<i class="fa fa-location-arrow "> '
                                ...
                                <!-- /.----------------------------------------------------------------- -->
                <!-- /.---------- -->
             		  <a href="{{ aurl('ads/'.$id.'/edit') }}" class="btn btn-success "><i class="fa fa-edit"></i> {{trans('admin.edit_page')}}</a>
                       <span>
                         {!! Form::open(['route'=>['ads.destroy',$id],'method'=>'delete' ,'class'=>'d-inline-block']) !!}
