            ...
            <section class="content">
                <div class="row">
                    <div class="col-12">
                        ...
                        <!-- /.card-header -->
                         <div class="card-body form_dark">
                                <!-- /.----------------------------------------------------------------- -->
                                <div class="box-body">
                                    {!! Form::open(['url'=>aurl('mall/'.$mall->id),'method'=>'put','files'=>true]) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 content_form_ar" >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::email('mob',$mall->mob,['class'=>'form-control']) !!}
                                                    </div><!-- /.form-group mob -->
                                                    <div class="form-group">
                                                        {!! Form::label('facebook',trans('admin.facebook')) !!}
                                                        {!! Form::email('facebook',$mall->facebook,['class'=>'form-control']) !!}
                                                    </div><!-- /.form-group facebook -->

                                                    <div class="form-group">
                                                        {!! Form::label('insta',trans('admin.insta')) !!}
                                                        {!! Form::email('insta',$mall->insta,['class'=>'form-control']) !!}
                                                    </div><!-- /.form-group insta -->
                                                    <div class="form-group">
                                                        {!! Form::label('country_id',trans('admin.country_id')) !!}
                                                        {!! Form::select('country_id',App\Countreis::pluck('country_name_'.session('lang'),'id'),$mall->country_id,['class'=>'form-control','placeholder'=>'........................']) !!}
                                                ...
                                                <div class="col-md-6 content_form_en" >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::number('code',$mall->code,['class'=>'form-control']) !!}
                                                    </div><!-- /.form-group code -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('contact_name',$mall->contact_name,['class'=>'form-control','placeholder'=>trans('admin.contact_name')]) !!}
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    @if(!empty($mall->logo))
                                                        <div> <img src="{{url('public/storage').Storage::url($mall->logo)}}" class="img_100px "></div>
                                                    @else
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::textarea('address',$mall->address,['class'=>'form-control','class'=>'form-control','placeholder'=>trans('admin.address')]) !!}
                                                    </div><!-- /.form-group contact_name -->
                                                 </div><!-- col-md-12-->
                                            </div><!--row-->
                                        </div><!-- box-body-->
                 ...
                 <div class="form-horizontal width_map" >
                    ...
                    <input type="hidden" class="form-control" value="{{$mall->lat}}" id="lat" name="lat" />
                    <input type="hidden" class="form-control" value="{{$mall->lng}}" id="lng"  name="lng" />
                     <div class="clearfix"></div>
                      <style>
                  .width_map{
                   width: 100%
...
*/
                ...
                $lat = !empty($mall->lat)?$lat:$d_lat;
                $lng = !empty($mall->lng)?$lng:$d_lng;
