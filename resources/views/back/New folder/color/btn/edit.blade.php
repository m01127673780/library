...
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#edit_color{{ $id }}"><i class="fa fa-edit"></i></button>
<!-- Modal -->
<div id="edit_color{{ $id }}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- /.----------------------------------------------------------------- -->
                 {!! Form::open(['route'=>['color.update',$id],'method'=>'put','class'=>'form_save_in_modal','files'=>true]) !!}
