{{--<a href="{{ aurl('color/'.$id.'/edit') }}" class="btn btn-info"><i class="fa fa-edit"></i></a>--}}
<!-- Trigger the modal with a button -->
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#show_color{{ $id }}"><i class="fa fa-eye"></i></button>
<!-- Modal -->
<div id="show_color{{ $id }}" class="modal  modal fade bd-example-modal-lg    fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                            <!-- /.----------------------------------------------------------------- -->
                             {!! Form::open(['url'=>aurl('weights/'.$id),'method'=>'get']) !!}
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::color('color',$color,['class'=>'form-control','disabled' ]) !!}
                                    ...
                                    <div class="col-md-6 content_form_en" >
                                        ...
                                        <div class="input-group icon_colo ">
                                            <div class="custom-file">
                                                ...
                                                {!! Form::file('icon',['class'=>'custom-file-input','id'=>'inputGroupFile02','disabled'] ) !!}
                                            </div>
                                        </div>
                                        @if(!empty($icon))
                ...
                <aside class="row model_actions">
                    ...
                    <div class="col-md-12 content_btn-actions_model">
                        <!-- /.---------- -->
                        <a href="{{ aurl('color/'.$id.'/edit') }}" class="btn btn-success "><i class="fa fa-edit"></i> {{trans('admin.edit_page')}}</a>
                        <span>
                         {!! Form::open(['route'=>['color.destroy',$id],'method'=>'delete' ,'class'=>'d-inline-block']) !!}
