...
<div class="modal fade bd-example-modal-lg" id="createNewweight" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    ...
                    <div class="box">
                        ...
                        <section class="modal_massage"> @include('back.message_error') </section>
                          <!-- /.box-header ,'required'=>'required' -->
                            <!-- /.----------------------------------------------------------------- -->
                                <div class="box-body">
                                    {!! Form::open(['url'=>aurl('weights/create_quick'),'files'=>true]) !!}
                                     <section class="form_modal_create">@include('back.weight.form.create')</section>
                                    {!! Form::close() !!}
                                </div><!-- box-body-->
                                <!-- /.----------------------------------------------------------------- -->
                     </div><!-- /.box -->
