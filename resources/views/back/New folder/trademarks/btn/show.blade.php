...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#show_trademarks{{ $id }}"><i class="fa fa-eye"></i></button>
<!-- Modal -->
<div id="show_trademarks{{ $id }}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- /.----------------------------------------------------------------- -->
                {{-- {!! Form::open(['route'=>['trademarks.update',$trademarks->id],'method'=>'put']) !!}--}}
                {!! Form::open(['url'=>aurl('trademarks/'.$id),'method'=>'get']) !!}

                <div class="form-group">
                    {!! Form::label('name',trans('admin.name_ar')) !!}
                    {!! Form::text('name_ar',$name_ar,['class'=>'form-control','class'=>'form-control','disabled'=>'disabled' ]) !!}
                </div><!-- /.form-group name -->
                <div class="form-group">
                    {!! Form::label('name_en',trans('admin.name_en')) !!}
                    {!! Form::text('name_en',$name_en,['class'=>'form-control','disabled'=>'disabled' ]) !!}
                ...
                <aside class="row model_actions">
                    <div class="col-md-12">
                        @if(empty($logo))
                            <img src="{{url('')}}/default/trademarks.png" class="img_120px"> <br/><br/>
                        @endif
                        @if(!empty($logo))
                    ...
                    <div class="col-md-12 content_btn-actions_model">
                        <!-- /.---------- -->
                        <a href="{{ aurl('trademarks/'.$id.'/edit') }}" class="btn btn-success "><i class="fa fa-edit"></i> {{trans('admin.edit_page')}}</a>
                        <span>
                         {!! Form::open(['route'=>['trademarks.destroy',$id],'method'=>'delete' ,'class'=>'d-inline-block']) !!}
