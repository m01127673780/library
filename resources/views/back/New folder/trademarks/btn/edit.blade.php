...
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#edit_trademarks{{ $id }}"><i class="fa fa-edit"></i></button>
<!-- Modal -->
<div id="edit_trademarks{{ $id }}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- /.----------------------------------------------------------------- -->
                 {!! Form::open(['route'=>['trademarks.update',$id],'method'=>'put','class'=>'form_save_in_modal','files'=>true]) !!}
 

                <div class="form-group">
                    {!! Form::label('name',trans('admin.name_ar')) !!}
                    {!! Form::text('name_ar',$name_ar,['class'=>'form-control','class'=>'form-control']) !!}
                </div><!-- /.form-group name -->
                <div class="form-group">
