            ...
            <section class="content">
                ...
                <aside class="row model_actions">
                    ...
                    <div class="col-md-12 content_btn-actions_model">
                        <!-- /.---------- -->
                        <a href="{{ aurl('manufacts/'.$manufacts->id.'/edit') }}" class="btn btn-success "><i class="fa fa-edit"></i> {{trans('admin.edit_page')}}</a>
                        <span>
                         {!! Form::open(['route'=>['manufacts.destroy',$manufacts->id],'method'=>'delete' ,'class'=>'d-inline-block']) !!}
                      ...
                      <a href="{{ aurl('manufacts') }}" class="btn btn-warning "><i class="fas fa-times"> </i> {{trans('admin.close')}}</a>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 content_form_ar" >
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('name_ar',$manufacts->name_ar,['class'=>'form-control','disabled']) !!}
                                                    </div><!-- /.form-group name_ar -->
                                                    <div class="form-group">
                                                        {!! Form::label('mob',trans('admin.mob')) !!}
                                                        {!! Form::email('mob',$manufacts->mob,['class'=>'form-control','disabled']) !!}
                                                    </div><!-- /.form-group mob -->
                                                    <div class="form-group">
                                                        {!! Form::label('facebook',trans('admin.facebook')) !!}
                                                        {!! Form::email('facebook',$manufacts->facebook,['class'=>'form-control','disabled']) !!}
                                                    </div><!-- /.form-group facebook -->

                                                    <div class="form-group">
                                                        {!! Form::label('insta',trans('admin.insta')) !!}
                                                        {!! Form::email('insta',$manufacts->insta,['class'=>'form-control','disabled']) !!}
                                                    </div><!-- /.form-group insta -->
                                                    <!----------------start  logo-->
                                                    <div class="input-group ">
                                                        <div class="custom-file">
                                                            {!! Form::label('logo',trans('admin.logo'),['class'=>'custom-file-label']) !!}
                                                            {!! Form::file('logo',['disabled','class'=>'custom-file-input','id'=>'inputGroupFile02'] ) !!}
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 content_form_en" >
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('name_en',$manufacts->name_en,['class'=>'form-control','disabled']) !!}
                                                    </div><!-- /.form-group name_en -->
                                                    <div class="form-group">
                                                        {!! Form::label('code',trans('admin.code')) !!}
                                                        {!! Form::number('code',$manufacts->code,['class'=>'form-control','disabled']) !!}
                                                    </div><!-- /.form-group code -->

                                                    <div class="form-group">
                                                        {!! Form::label('twitter',trans('admin.twitter')) !!}
                                                        {!! Form::text('twitter',$manufacts->twitter,['class'=>'form-control','disabled']) !!}
                                                    </div><!-- /.form-group twitter -->

                                                    <div class="form-group">
                                                        {!! Form::label('email',trans('admin.email')) !!}
                                                        {!! Form::text('email',$manufacts->email,['class'=>'form-control','disabled']) !!}
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('address',$manufacts->address,['disabled','class'=>'form-control','placeholder'=>trans('admin.address')]) !!}
                                                    </div><!-- /.form-group contact_name -->
                                                </div><!--col-md-12-->
                                            </div><!--row-->
                                        </div><!-- box-body-->
