...
<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#del_flavor{{$id}}">
    <i class="fa fa-trash"></i>
</button>

<!-- Modal -->
<div class="modal fade" id="del_flavor{{$id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['route'=>['flavors.destroy',$id],'method'=>'delete']) !!}
