...
<div id="mainCoantiner">
  <div class="main-header">
    ...
    <ul>
      ...
      <li><a  href="{{url('/')}}"><i class="fas fa-eye"></i></a></li>
    </ul>
  </div>
  <div class="folio-btn">
    <a class="folio-btn-item ajax"  target="_blank"><span class="folio-btn-dot"></span><span class="folio-btn-dot"></span><span class="folio-btn-dot"></span><span class="folio-btn-dot"></span><span class="folio-btn-dot"></span><span class="folio-btn-dot"></span><span class="folio-btn-dot"></span><span class="folio-btn-dot"></span><span class="folio-btn-dot"></span></a>
  </div>
</div>
        ...
        <div class="col-xl-12 col-md-12 col-md-12">
          <div class="card">
            ...
            <div class="card-body wow-bg" id="formBg">
              <h3 class="colorboard">{{trans('admin.login')}} </h3>

              <p class="text-muted">{{trans('admin.Sign_In_to_your_account')}} </p>

              <div class="input-group mb-3">
               <input type="email" class="form-control textbox-dg" name="email" placeholder="{{trans('admin.email')}}"> </div>
               <div class="input-group mb-4">
               	<input type="password" name="password" class="form-control textbox-dg" placeholder="{{trans('admin.password')}}">

               	 </div>

              <div class="row">
                <div class="col-12">
                  <button type="submit" class="btn btn-primary btn-block logn-btn">{{trans('admin.login')}} </button>
                 </div>
                 <input type="checkbox" id="remember" name="rememberme" value="1">
                            <label for="remember">   {{trans('admin.remember_me')}}   </label>


                <div class="col-12"> <a href="{{aurl('forgot/password')}}" class="btn btn-link box-shadow-0 px-0"> {{trans('admin.i_forgot_my_password')}} </a> </div>
              </div>
