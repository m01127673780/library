...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#show_news{{ $id }}"><i class="fa fa-eye"></i></button>
<!-- Modal -->
<div id="show_news{{ $id }}" class="modal fade" role="dialog">
