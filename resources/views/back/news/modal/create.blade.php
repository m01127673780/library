...
<div class="modal fade bd-example-modal-lg" id="createNewnews" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                ...
                <div class="container-fluid">
                    ...
                    <div class="box">
                        <div class="box-titleer">
                            <center class="box-content"><h3 class="title_content">{{ trans('admin.create_new_news') }}</h3></center>
                        </div>
