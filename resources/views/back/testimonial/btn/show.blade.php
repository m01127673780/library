...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#show_testimonial{{ $id }}"><i class="fa fa-eye"></i></button>
<!-- Modal -->
<div id="show_testimonial{{ $id }}" class="modal fade" role="dialog">
