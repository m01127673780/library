{{--<a href="{{ aurl('testimonial/'.$id.'/edit') }}" class="btn btn-info"><i class="fa fa-edit"></i></a>--}}


 <!-- Trigger the modal with a button -->
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#edit_testimonial{{ $id }}"><i class="fa fa-edit"></i></button>
<!-- Modal -->
<div id="edit_testimonial{{ $id }}" class="modal fade" role="dialog">
  ...
  <!-- /.----------------------------------------------------------------- -->
                             <div class="box-body">
                                     {!! Form::open(['route'=>['testimonial.update',$id],'method'=>'put','class'=>'form_save_in_modal','files'=>true]) !!}
                                    <div class="row">
                                   <div class="col-md-12 content_form_ar" >
                                    ...
                                    <div class="input-group ">
                                        <div class="custom-file">
                                            {!! Form::label('photo',trans('admin.photo_testimonial'),['class'=>'custom-file-label']) !!}
                                     ...
                                     @if(!empty($photo))
                                       ...
                                       @else
                                      <div class="text-center"> <img   src="{{url('default')}}/testimonial.png" class="img_100px"></div>
                                       @endif
                                   <!----------------End photo-->
                                   </section> 
                               </div><!-- col-md-12-->
                             ...
                             <!--        {{ Form::button('<i class="fa fa-location-arrow "> '
                                        . trans('admin.save').'
                                        </i> <i class="fas fa-testimonial-h"> </i> ' ,
                                ...
                                <!-- /.----------------------------------------------------------------- -->
                <!-- /.---------- -->
             		  <a href="{{ aurl('testimonial/'.$id.'/edit') }}" class="btn btn-success "><i class="fa fa-edit"></i> {{trans('admin.edit_page')}}</a>
                       <span>
                         {!! Form::open(['route'=>['testimonial.destroy',$id],'method'=>'delete' ,'class'=>'d-inline-block']) !!}
