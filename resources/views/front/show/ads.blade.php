            ...
            <div class="row content_footer_sections">
                <div class="col-md-6 article_large article ">
                    <div class="content_author_article d-n">
                        ...
                        <!--    <img class="img_author" src="{{url('public/storage').'/'.$adsfind->photo}}">  <span class="pont_on_line">  </span>-->
                        <!--</div><!--content_img_author-->
                        <div class="content_name_data_author">
                            <span class="name_author"><i class="fa fa-star"> </i> {{$adsfind['title_'.$lang]}}</span><!--name_author--> <br>
                            <span class="status_author">{{trans('admin.updated_at')}}</span> <span class="data_author">{{$adsfind->updated_at}}</span>
                            <span class="status_author">{{trans('admin.created_at')}}</span> <span class="data_author">{{$adsfind->created_at}}</span>
                        </div><!--content_img_author-->
                    ...
                    <article class="content_post">
                        <div class="post">
                            ...
                            <div class="text-center m_t_100"> {{$adsfind['title_'.$lang]}}</div>
                            <hr>

                            <div class="text-center m_t_100">  {{$adsfind['content_'.$lang]}} </div>
                        </div>
                    </article>
                </div><!--col-md-8-->
                <div class="col-md-6 article_small article ">
                    ...
                    <div class="img_this_article">
                      <img src="{{url('public/storage').'/'.$adsfind->photo}}" class="img_this_article" style="height: 422px"> 
