            ...
            <div class="row content_footer_sections">
                <div class="col-md-6 article_large article ">
                    <div class="content_author_article d-n">
                        ...
                        <!--    <img class="img_author" src="{{url('public/storage').'/'.$newsfind->photo}}">  <span class="pont_on_line">  </span>-->
                        <!--</div><!--content_img_author--> 
                        <div class="content_name_data_author">
                            <span class="name_author"><i class="fa fa-star"> </i> {{$newsfind['title_'.$lang]}}</span><!--name_author--> <br>
                            <span class="status_author">{{trans('admin.updated_at')}}</span> <span class="data_author">{{$newsfind->updated_at}}</span>
                            <span class="status_author">{{trans('admin.created_at')}}</span> <span class="data_author">{{$newsfind->created_at}}</span>
                        </div><!--content_img_author-->
                    </div><!--content_author_article-->
                    <article class="content_post">
                        <div class="post">
                        {{$newsfind['content_'.$lang]}}
                        </div>
                    </article>
                </div><!--col-md-8-->
                <div class="col-md-6 article_small article ">
                    ...
                    <div class="img_this_article">
                     <img src="{{url('public/storage').'/'.$newsfind->photo}}" class="img_this_article" style="height: 422px"> 
